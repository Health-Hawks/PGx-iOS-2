...
class Screen16VC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    @IBAction func homeBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "HomefromS16", sender: self)
    ...
    override func viewDidLoad() {
        ...
        tapRecognizer.addTarget(self, action: #selector(Screen16VC.didTapView))
