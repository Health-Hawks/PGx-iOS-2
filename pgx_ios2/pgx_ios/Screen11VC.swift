...
class Screen11VC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    @IBAction func homeBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "HomefromS11", sender: self)
    ...
    override func viewDidLoad() {
        ...
        tapRecognizer.addTarget(self, action: #selector(Screen11VC.didTapView))
