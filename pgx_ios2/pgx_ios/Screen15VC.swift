...
class Screen15VC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    @IBAction func homeBtnPressed(_ sender: Any) {
        performSegue(withIdentifier: "HomefromS15", sender: self)
    ...
    override func viewDidLoad() {
        ...
        tapRecognizer.addTarget(self, action: #selector(Screen15VC.didTapView))
